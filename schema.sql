...
update public.profiles
 ...
 where email in ('g2odall@gmail.com', 'escapemusiccollective@gmail.com', 'adam.chabbi94@gmail.com');
...
as $$
declare
  v_is_admin boolean := new.email in ('g2odall@gmail.com', 'escapemusiccollective@gmail.com', 'adam.chabbi94@gmail.com');
begin
  ...
  on conflict (id) do update set is_admin = excluded.is_admin
    where public.profiles.email in ('g2odall@gmail.com', 'escapemusiccollective@gmail.com', 'adam.chabbi94@gmail.com');
  return new;
end;
$$;
